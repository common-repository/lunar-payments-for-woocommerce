...
class WC_Payment_Token_Lunar extends WC_Payment_Token {
	/** @protected string Token Type String */
	protected $type = 'lunar';

	/**
	 * Stores Lunar payment token data.
	 *
	 * @var array
	 */
	...
	public function get_display_name( $deprecated = '' ) {
		...
		$display = sprintf(
			__( '%s ending in %s', 'lunar-payments-for-woocommerce' ),
			$label,
			$this->get_last4()
		);
